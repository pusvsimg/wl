...
**在线体验地址：** https://cods.webredirect.org/wl/

直接点击链接即可开始游戏，无需任何下载或安装！

**本地体验：** 直接在浏览器中打开 `index.html` 文件即可开始游戏
...
**体验方式：** 在线体验 https://cods.webredirect.org/wl/ 或本地打开 `index.html` 文件
